                        ...
                        if (unfinishedMeterReadingsCollection != null) {
                            ...
                            when (readingsResult) {
                                is Result.Success<*> -> {
                                    ...
                                    mutableCollectionReadings.add(finishedCollectionCollectorReading)
                                    val collectionReadings =
                                        mutableCollectionReadings.toList().sortByOldestFirst()
                                    ...
                                    val updatedData = DatabaseMeterReadingsCollectionMainDataUpdate(
                                    ...
                                    //Pass This
                                    val newCollectionCollectorReading = DatabaseMeterReading(
                                        meterReadingId = UUID.randomUUID()
                                            .toString(),
                                        parentMeterId = meter!!.meterId,
                                    ...
                                    //Pass this
                                    val newMeterCollection = DatabaseMeterReadingsCollection(
